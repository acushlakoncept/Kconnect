...
public class UsersAdapter2 extends ArrayAdapter<ParseObject> {
	
	public static final String TAG = UsersAdapter2.class.getSimpleName();
	...
	public UsersAdapter2(Context context, ParseObject[] users, ArrayList<ParseObject> userRelations) {
